...
angular.module('testApp')
  .controller('MainCtrl', function ($scope) {
    ...
    $scope.activities = [
    	{
    		...
    		'장소' : '강릉원주대학교 외 23곳',
    		'내용' : "대학생 선생님이 지역의 초등학생에게 5주간 블록코딩(엔트리)을활용하여 소프트웨어의 원리를 가르치고, 학생이 팀을 이뤄 프로젝트를 기획하고 실현할 수 있도록 지도하는 프로그램입니다. <br>* 교육생 모집은 소프트웨어야 놀자 사이트를 통해 이루어집니다."
    	},
    	{
    		'제목' : '여름방학 소프트웨어 캠프',
    		'일정' : '미정 (상세 일정 추후 공지)',
    		...
    		'장소' : '강릉원주대학교 외 23곳',
    		'내용' : "커넥트재단이 후원하는 여름방학 소프트웨어 교육 캠프로 각 지역 파트너 대학에서 주도하는 교육 프로그램입니다.소프트웨어 교육에 대한 궁금증을 가진 학부모님과 학생에게 대학에서 기획한 양질의 교육을 제공합니다.<br>* 본 프로그램은 일부 파트너 대학에서만 개최됩니다. <br>* 참가자 모집은 소프트웨어야 놀자 사이트를 통해 이루어집니다.",
    	},
    	{
    		'제목' : '찾아가는 소프트웨어 교실',
    ...
    $scope.activity = {
        ...
        "커넥트스쿨의 모든 교육 프로그램은 무료로 이루어지나요?" : "네, 커넥트스쿨은 여러 가지 현실적인 이유로 소프트웨어 교육을 받지 못하는 학생들을 위해 마련된 교육 프로그램입니다. 소프트웨어 교육을 받길 희망하는 학생이라면 누구나 비용 부담 없이 참여할 수  있습니다. ",
