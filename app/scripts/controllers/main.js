...
angular.module('testApp')
  .controller('MainCtrl', function ($scope) {
    ...
    $scope.recruit = {
    	...
    	'<div>모집일정</div>' : "<div>· <span>지원기간: 2017.03.10(금) ~ 2017.03.30(목) 오후 24시까지 </span><br>· 서류합격자 발표: 2017.03.31(메일, 문자)<br>· 면접전형: 2017.04.03 ~ 2017.04.09(지역별 실시)<br>· 최종합격자 발표: 2017.04.11(메일, 문자)</div>",
